...
name: sync-aicap
description: >-
  同步 AICAP skills 到最新版本：git pull → 检测变动 → pnpm run ai:generate → pnpm run
  setup:skills → 展示新增/删除/更新的 skill 列表。 若本地有未推送的新 skill，还可更新文档并开 PR 推给团队。 触发：同步
  AICAP / sync aicap / 更新 AICAP / 拉取最新 skills / AICAP 有更新 / update aicap skills
  / 把本地 skill 提交 PR
---
# sync-aicap
